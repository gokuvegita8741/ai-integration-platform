...
export function ChatSidebar({ className, onSelect }: ChatSidebarProps) {
    ...
    return (
        <div className={cn("h-full flex flex-col bg-white dark:bg-black border-r border-zinc-200 dark:border-zinc-800", className)}>
            {/* Header */}
            <div className="px-3 py-2 mt-1">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        <h1 className="font-bold text-md leading-tight text-zinc-900 dark:text-white">QuickGPT</h1>
            ...
            <div className="flex-1 overflow-y-auto px-3 py-2 space-y-1 scrollbar-thin scrollbar-thumb-zinc-200 dark:scrollbar-thumb-zinc-800">
                <div className="flex items-center justify-between">
                    <h3 className="text-xs font-semibold text-zinc-500 dark:text-zinc-400 px-3 py-2 uppercase tracking-wider">Recent Chats ({chats.length})</h3>
                    <Plus onClick={handleCreateNew} className="w-4 h-4 text-zinc-400 cursor-pointer hover:bg-zinc-200 dark:hover:bg-zinc-800 " />
                </div>
                    ...
                    >
                        <div className="min-w-0 flex-1 mr-2">
                            <h4 className={cn(
                                ...
                                activeChatId === chat.id ? "text-zinc-900 dark:text-zinc-100" : "text-zinc-600 dark:text-zinc-400"
                            )}>
                                {chat.title}
                            </h4>
